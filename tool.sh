...
tools(){
    figlet -f slant "VIENBENIDO" | lolcat
...
password(){
    figlet -f smslant "DEGO TOOL" | lolcat
    echo -e $green"        { Version 2.0 }\n"

    echo -e $green"{";
    echo -e $yellow" Coder : Dego Max,";
    echo -e $yellow" FB : Carlos Max,";
    echo -e $yellow" IG : DegoMax,";
    echo -e $green"}\n";

    echo -e $blue"{ Login Dulu Bro }";
    echo -e $yellow"Nota : usa este script para un buen uso att: Dego Max ";
